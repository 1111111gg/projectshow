...
define([
    ...
    ReactToeControl.prototype.playerMoves = function (player, row, column) {
        ...
        if (typeof _currentNodeId === 'string') {
            ...
            context.managerConfig.activeNode = _currentNodeId;
            context.managerConfig.namespace = null;
            context.pluginConfig = {row, column};
            _logger.info(context.pluginConfig)
    ...
    ReactToeControl.prototype.undo = function (player) {
        console.log(player);
        const {_client, _currentNodeId, _logger} = this;
        if (typeof _currentNodeId === 'string') {
