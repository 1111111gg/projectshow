...
define([
    ...
    BuildDescriptor.prototype.main = function (callback) {
        ...
        const descriptor = {player:CONSTANTS.PLAYER.WHITE,board:[],position2path:{}};
        const nodeHash = {};
        ...
        .then(inner => {
            ...
            descriptor.position2path = UTILS.getPositionHash(core, META,nodeHash[descriptor.boardPath], nodeHash);
